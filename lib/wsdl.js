...
WSDL.prototype.magentoArrayValues = ['productIds', 'additional_attributes'];
WSDL.prototype.magentoArrayValuesWrapper = 'complexObjectArray';
...
WSDL.prototype.objectToXML = function(obj, name, nsPrefix, nsURI, isFirst, xmlnsAttr, schemaObject, nsContext) {
  ...
  if (Array.isArray(obj)) {
    ...
    if (self.magentoArrayValues.indexOf(name) > -1) {
      parts.push([ '<', self.magentoArrayValuesWrapper, '>', xmlEscape(obj), '</', self.magentoArrayValuesWrapper, '>' ].join(''));
    } else {
